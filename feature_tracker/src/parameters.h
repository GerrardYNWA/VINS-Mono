...
extern int EQUALIZE;                       // 如果图像太亮或者太暗，则为1，即进行直方图均衡化
extern int FISHEYE;                        // 如果是鱼眼相机，则为1
extern bool PUB_THIS_FRAME;                // 是否需要发布特征点

void readParameters(ros::NodeHandle &n); // feature_tracker_node文件的main函数中被调用
